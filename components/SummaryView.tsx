    ...
    try {
      ...
      if (type === 'image') {
        ...
        for (let i = 0; i < totalPages; i++) {
          ...
          pdf.text('HS COCKPIT v4.0 - RÉSUMÉ DES ACTIVITÉS', logoImg.complete && logoImg.naturalWidth > 0 ? marginSide + 15 : marginSide, 12);
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-1000">
      ...
      <div ref={contentRef} className="space-y-10 p-1">
        {/* HEADER EXPORT - Visible uniquement lors de l'export */}
        <div className={`${exporting ? 'flex' : 'hidden'} items-center justify-between border-b-2 border-slate-900 pb-6 mb-8`}>
