    ...
    try {
      ...
      if (type === 'image') {
        ...
        for (let i = 0; i < totalPages; i++) {
          ...
          // Add the full image, but it will be clipped by the white rectangles we add later
          pdf.addImage(imgData, 'PNG', marginSide, position, contentWidth, imgHeightInPdf);
          
          // Cover top and bottom overflow to respect margins
          ...
          pdf.text('HS COCKPIT v4.0 - RAPPORT GLOBAL DE SYNTHÈSE', logoImg.complete && logoImg.naturalWidth > 0 ? marginSide + 15 : marginSide, 12);
          ...
          pdf.text(`Document Officiel - ${branding?.hashtag || ''}`, marginSide, pdfHeight - 10);
