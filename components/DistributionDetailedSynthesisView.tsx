      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
        <div className="flex flex-wrap items-center gap-3 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <select 
            ...
            className="bg-slate-50 border-none rounded-lg text-[10px] font-bold uppercase px-3 py-1.5 focus:ring-2 focus:ring-blue-500 outline-none"
          >
          ...
          {filterType === 'day' && (
            <input 
              ...
              className="bg-slate-50 border-none rounded-lg text-[10px] font-bold px-3 py-1.5 focus:ring-2 focus:ring-blue-500 outline-none"
            />
          )}
        ...
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            <div className="bg-slate-50 px-6 py-3 rounded-2xl border border-slate-100 text-center min-w-[120px]">
              <p className="text-[8px] font-black text-slate-400 uppercase mb-1">Distribution Totale</p>
