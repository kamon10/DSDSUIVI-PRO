...
export const SITES_DATA = [
  ...
  { code: "7", name: "SP HG ANYAMA", region: "PRES ABIDJAN", annualObjective: 5000, manager: "Dr. ANAUD Née YAO Akissi Marie Chantal", email: "akissimariechantaly@gmail.com", phone: "01 02 62 13 43", coords: [5.4947, -4.0519] as [number, number] },
...
export const PRODUCT_COLORS: Record<string, string> = {
  "CGR": "#ef4444", 
  "CGR ADULTE": "#ef4444",
  "CGR NOURRISSON": "#ef4444",
  "CGR NOURRISON": "#ef4444",
  "CGR PEDIATRIQUE": "#ef4444",
  "CONCENTRE DE PLAQUETTES": "#3b82f6", 
  "PLASMA A USAGE THERAPEUTIQUE": "#facc15",
  "AUTRES": "#94a3b8"
};
